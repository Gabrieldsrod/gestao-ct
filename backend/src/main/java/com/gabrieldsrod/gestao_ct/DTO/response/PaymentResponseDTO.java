...
public record PaymentResponseDTO(
    ...
    public PaymentResponseDTO(MemberPayment payment) {
        this(
                ...
                payment.getDueDate() != null ? payment.getDueDate().format(DateUtils.BR_FORMATTER) : null,
                payment.getPaymentDate() != null ? payment.getPaymentDate().format(DateUtils.BR_FORMATTER) : null,
